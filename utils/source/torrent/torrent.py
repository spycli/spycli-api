...
class TorrentClient:
    ...
    def search_on_site(self, site, query, page, limit_item):
    ...
    def search_all_sites(self, query, page, limit_item):
        """Search for torrents across all sites."""
        endpoint = "/api/v1/all/search"
        params = {'site': query, 'query': query, 'limit': limit_item, 'page': page}
        return self._send_request(endpoint, params=params)
